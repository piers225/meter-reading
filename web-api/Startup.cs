    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddEntityFrameworkSqlite()
                .AddDbContext<DatabaseContext>(options => options.UseSqlite(Configuration.GetConnectionString("SqliteConnection")));

            services.AddTransient<IIsUniqueReading, IsUniqueReading>();
            services.AddTransient<IValidAccountNumber, ValidAccountNumber>();
            services.AddTransient<IIsValidMeterReading, IsValidMeterReading>();
